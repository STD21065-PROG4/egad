package com.company.base6.unit;
...
import com.company.base6.conf.FacadeIT;
import com.company.base6.endpoint.event.consumer.model.ConsumableEvent;
import com.company.base6.endpoint.event.consumer.model.ConsumableEventTyper;
import com.company.base6.endpoint.event.consumer.model.TypedEvent;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("com.company.base6.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("com.company.base6.endpoint.event.model.UuidCreated", payload);
