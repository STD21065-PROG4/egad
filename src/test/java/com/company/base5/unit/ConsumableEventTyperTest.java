package com.company.base5.unit;
...
import com.company.base5.endpoint.event.consumer.model.ConsumableEvent;
import com.company.base5.endpoint.event.consumer.model.ConsumableEventTyper;
import com.company.base5.endpoint.event.consumer.model.TypedEvent;
import com.company.base5.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("com.company.base5.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("com.company.base5.endpoint.event.model.UuidCreated", payload);
