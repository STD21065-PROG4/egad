package com.company.base5.endpoint.event;
...
import com.company.base5.endpoint.event.consumer.EventConsumer;
  ...
  void uuid_created_is_persisted() throws InterruptedException, JsonProcessingException {
    ...
    subject.accept(
        List.of(
            new ConsumableEvent(
                new TypedEvent(
                    "com.company.base5.endpoint.event.model.UuidCreated", payloadReceived),
                () -> {},
                () -> {})));
