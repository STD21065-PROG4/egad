...
import static com.company.base5.endpoint.event.EventStack.EVENT_STACK_1;

import com.company.base5.PojaGenerated;
import com.company.base5.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.company.base5.event1";
    return "com.company.base5.event2";
  }
}
